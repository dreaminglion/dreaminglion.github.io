...
野兽派 | 2016-02 至 2017-06 | Android Leader 工程师 | 100-499人 &nbsp;&nbsp; C轮
侠客群控 | 2017-06 至今 | Android 逆向工程师 | 100-199人 &nbsp;&nbsp; A轮
...
- 熟练掌握 WebView 的优化，使用腾讯 X5 优化 Android 碎片化的 WebView 内核，使 H5 更高效，防劫持等。
...
- 理解使用 mvp 设计模式，并优化 mvp 设计模式需要定义过多 interface 实现多个 presenter。
...
项目描述：通过模拟点击、UI 测试等技术，达到帮助用户快速便捷操作的微信，维护与粉丝之间的互动。

功能模块：
1. 使用 Xposed 给微信，hook 一些函数方便快捷调用。
2. 使用 Android 系统辅助点击功能，帮助用户对 app 进行操作。
3. 定时任务功能，便于统筹工作，便于处理重复、特定时间需求的任务。
4. 添加粉丝，获取附近人、群好友、摇一摇等。
5. 粉丝管理，查找僵尸粉、朋友圈、智能回复等活跃粉丝气氛。
